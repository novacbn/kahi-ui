...
<Container>
    <article id="typography-anchors">
        ...
        <Anchor href="https://google.com" rel="noopener noreferrer" target="_blank"
            >Click here</Anchor
        >
        to goto Google!
    </article>
    ...
    <article id="typography-formatting">
        ...
        <Formatting.CodeBlock
            >&lt;Heading&gt;Pre-formatted Code&lt;/Heading&gt;</Formatting.CodeBlock
        >
    </article>
    ...
    <article id="typography-blockquotes">
        <Heading>Typography :: Blockquotes</Heading>
        ...
        <Quote.Container>
            ...
            <Quote.Cite>
                <Anchor href="#typography-blockquote">Said no one, ever.</Anchor>
            </Quote.Cite>
        </Quote.Container>
