...
<Stack orientation="horizontal" spacing="medium" variation="wrap">
    <div>
        ...
        <Box palette="dark" padding="small">
            <Mosaic {...$$props} sizing="tiny" spacing="medium">
    ...
    <div>
        ...
        <Box palette="dark" padding="small">
            <Mosaic {...$$props} sizing="small" spacing="medium">
                <Box palette="alert" style="height:3rem;" />
                <Box palette="affirmative" style="height:3rem;" />
                <Box palette="negative" style="height:3rem;" />
            </Mosaic>
    ...
    <div>
        ...
        <Box palette="dark" padding="small">
            <Mosaic {...$$props} sizing="medium" spacing="medium">
                <Box palette="alert" style="height:3rem;" />
                <Box palette="affirmative" style="height:3rem;" />
                <Box palette="negative" style="height:3rem;" />
            </Mosaic>
    ...
    <div>
        ...
        <Box palette="dark" padding="small">
            <Mosaic {...$$props} sizing="large" spacing="medium">
                <Box palette="alert" style="height:3rem;" />
                <Box palette="affirmative" style="height:3rem;" />
                <Box palette="negative" style="height:3rem;" />
            </Mosaic>
    ...
    <div>
        ...
        <Box palette="dark" padding="small">
            <Mosaic {...$$props} sizing="huge" spacing="medium">
                <Box palette="alert" style="height:3rem;" />
                <Box palette="affirmative" style="height:3rem;" />
                <Box palette="negative" style="height:3rem;" />
            </Mosaic>
