<script lang="ts">
    import type {DESIGN_FIT_ARGUMENT} from "../../../lib/types/fit";
    import type {DESIGN_HIDDEN_ARGUMENT} from "../../../lib/types/hidden";
    import type {DESIGN_SHAPE_ARGUMENT} from "../../../lib/types/shapes";
    ...
    export let fit: DESIGN_FIT_ARGUMENT | undefined = undefined;
    export let shape: DESIGN_SHAPE_ARGUMENT | undefined = undefined;
    export let size: DESIGN_SIZE_ARGUMENT | undefined = undefined;
    export let variation: "icon" | undefined = undefined;

</script>

<Figure bind:element {...$$props}>
    <slot />
</Figure>
