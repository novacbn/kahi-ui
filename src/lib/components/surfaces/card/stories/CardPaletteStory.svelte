...
<Mosaic sizing="huge" spacing="medium">
    ...
    <Card.Container {...$$props} palette="accent">
        <Card.Figure>
            <img src={IMAGE_BACKGROUND} />
        </Card.Figure>
    ...
    <Card.Container {...$$props} palette="dark">
        <Card.Figure>
            <img src={IMAGE_BACKGROUND} />
        </Card.Figure>
    ...
    <Card.Container {...$$props} palette="light">
        <Card.Figure>
            <img src={IMAGE_BACKGROUND} />
        </Card.Figure>
    ...
    <Card.Container {...$$props} palette="alert">
        <Card.Figure>
            <img src={IMAGE_BACKGROUND} />
        </Card.Figure>
    ...
    <Card.Container {...$$props} palette="affirmative">
        <Card.Figure>
            <img src={IMAGE_BACKGROUND} />
        </Card.Figure>
    ...
    <Card.Container {...$$props} palette="negative">
        <Card.Figure>
            <img src={IMAGE_BACKGROUND} />
        </Card.Figure>
