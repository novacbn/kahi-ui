<script lang="ts">
    ...
    import type {DESIGN_VIEWPORT_ARGUMENT} from "../../../lib/types/viewports";
    ...
    export let is: "div" | "main" = "div";
    export let viewport: DESIGN_VIEWPORT_ARGUMENT | undefined = undefined;
